...
Built on the [PubMed 20k RCT dataset](https://github.com/Franck-Dernoncourt/pubmed-rct).
...
| **JWT Authentication** | Register and login to access the API |
| **History** | Every classification is saved and viewable |
| **Analytics** | Usage stats and label distribution per user |
| **REST API** | Fully documented at `/docs` via FastAPI auto-docs |
